...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.pb_loadFiles, 0, 1, 1, 1)
        self.lw_FileList = QtGui.QListWidget(self.groupBox)
        self.lw_FileList.setObjectName("lw_FileList")
        self.gridLayout.addWidget(self.lw_FileList, 2, 0, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pb_loadFiles.setText(QtGui.QApplication.translate("Dialog", "Load", None, QtGui.QApplication.UnicodeUTF8))
